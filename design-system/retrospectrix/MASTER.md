...
**Project:** Retrospectrix
**Generated:** 2026-03-14 20:52:15
...
|------|-----|--------------|
| Primary | `#1a1a1a` | `--color-primary` |
| Secondary | `#5c5c5c` | `--color-secondary` |
| CTA/Accent | `#1a1a1a` | `--color-cta` |
| Background | `#f9f9f9` | `--color-background` |
| Text | `#1a1a1a` | `--color-text` |
| Muted | `#858585` | `--color-muted` |
| Border | `#e2e2e2` | `--color-border` |

**Color Notes:** Pure monochrome. Color only in semantic column indicators (green/red/blue dots).

### Typography

- **Heading Font:** Varela Round
- **Body Font:** Nunito Sans
- **Mood:** soft, rounded, friendly, approachable, warm, modern
